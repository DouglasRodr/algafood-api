...
public interface EstatisticasControllerOpenApi {
	...
	@Operation(
		...
		parameters = {
			...
			@Parameter(in = ParameterIn.QUERY, 
				...
				description = "Data/hora inicial da criação do pedido", example = "2019-12-01T00:00:00Z", 
			...
			responses = {
					@ApiResponse(responseCode = "200", content = {
							...
							@Content(mediaType = "application/pdf", schema = 
	...
	List<VendaDiaria> consultarVendasDiarias(
			...
			@Parameter(description = "Deslocamento de horário a ser considerado na consulta em relação ao UTC", schema = 
				@Schema(type = "string", defaultValue = "+00:00")) String timeOffset
	);
